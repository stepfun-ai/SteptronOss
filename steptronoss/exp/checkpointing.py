...
class ConstantCheckpointConfig(CheckpointConfig):
    auto_resume: bool
    ...
    def __init__(self):
        ...
        self.load_option = LoadOptions
        self.load_safetensors = False
        self.save_option = SaveOptions
        ...
        if getattr(self, "_allow_search", False):
